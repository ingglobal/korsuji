...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>" tr_id="<?php echo $row['orp_idx'] ?>">
        ...
        <td class="td_end_date">
            <?php ;//substr($row['orp_done_date'],2,8)?>
			<input type="hidden" name="orp_idx[<?=$row['oop_idx']?>]" value="<?=$row['orp_idx']?>">
			<input type="text" name="orp_done_date[<?=$row['oop_idx']?>]" oop_idx="<?=$row['oop_idx']?>" value="<?=$row['orp_done_date']?>" readonly class="" style="width:95px;">
        </td>
        <td class="td_oro_cnt">
